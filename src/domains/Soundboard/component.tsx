...
export function Soundboard({ soundSet, audioCacheRef, soundboardPlayer }: { soundSet: SoundSet; audioCacheRef: React.RefObject<AudioCache>; soundboardPlayer: SoundboardPlayer }) {
